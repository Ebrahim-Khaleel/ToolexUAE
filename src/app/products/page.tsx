...
export default async function Products({ searchParams }: { searchParams?: Promise<{ q?: string; page?: string }> }) {
  ...
  const filteredProducts = searchTerm
    ...
    : products;
  // Pagination logic using URL search params
            ...
            <div className="mt-12">
              <Pagination>
                <PaginationContent>
                  <PaginationItem>
                    <PaginationPrevious 
                      href={currentPage > 1 ? `?${createSearchParams({ q: searchTerm, page: (currentPage - 1).toString() })}` : undefined}
                  ...
                  <PaginationItem>
                    <PaginationNext 
                      href={currentPage < totalPages ? `?${createSearchParams({ q: searchTerm, page: (currentPage + 1).toString() })}` : undefined}
